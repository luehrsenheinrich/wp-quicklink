...
global.addEventListener( 'load', () => {
	...
	if (
		'number' === typeof exportedOptions.limit &&
		exportedOptions.limit > 0
	) {
	...
	if (
		'number' === typeof exportedOptions.throttle &&
		exportedOptions.throttle > 0
	) {
	...
	if (
		'string' === typeof exportedOptions.timeoutFn &&
		'requestIdleCallback' !== exportedOptions.timeoutFn &&
		typeof 'function' === window[ exportedOptions.timeoutFn ]
	) {
	...
	if (
		'string' === typeof exportedOptions.onError &&
		typeof 'function' === window[ exportedOptions.onError ]
	) {
	...
	if (
		Array.isArray( exportedOptions.origins ) &&
		0 < exportedOptions.origins.length
	) {
	...
	if (
		Array.isArray( exportedOptions.ignores ) &&
		0 < exportedOptions.ignores.length
	) {
	 ...
	 */
	if (
		Array.isArray( exportedOptions.urls ) &&
		0 < exportedOptions.urls.length
	) {
